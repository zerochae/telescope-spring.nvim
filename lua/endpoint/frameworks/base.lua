...
-- All framework adapters should implement these methods

local M = {}

-- Framework adapter interface that all frameworks should implement
M.FrameworkAdapter = {
  ...
  get_grep_cmd = function(method, config)
    error "get_grep_cmd must be implemented by framework adapter"
  end,
  ...
  parse_line = function(line, method)
    error "parse_line must be implemented by framework adapter"
  end,

  -- Get method-specific patterns for this framework
  -- @return table: { get = {...}, post = {...}, ... }
  get_patterns = function()
    error "get_patterns must be implemented by framework adapter"
  end,
